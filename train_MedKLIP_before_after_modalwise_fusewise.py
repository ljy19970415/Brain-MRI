...
from models.model_MedKLIP_before_after_fuse import MedKLIP as MedKLIP 
from models.model_MedKLIP_14class_before_after_fuse import MedKLIP as MedKLIP_14
...
def train(model, image_encoder, text_encoder, fuseModule, tokenizer, data_loader, optimizer, epoch, warmup_steps, device, scheduler, config):
    ...
    for i, sample in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        entity = sample['entity'] # [(b,dwi),(b, t1),(b,t2),(b,t2f),(b,fuse)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/home/ps/leijiayu/CODE/MedKLIP/Pretrain_MedKLIP_bce/configs/Pretrain_MedKLIP_lorep_morecls_fusereport_nocl.yaml')
    parser.add_argument('--finetune_checkpoint', default='')
    parser.add_argument('--output_dir', default='outputdir_34_kad_sc_lorep_morecls_before_after_fuse_kad_nocl')
    parser.add_argument('--device', default='cuda')
    parser.add_argument('--gpu', type=str,default='7,4,5,6', help='gpu')
